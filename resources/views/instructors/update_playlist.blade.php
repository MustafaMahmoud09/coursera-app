...
<body>
    ...
    <section class="playlist-form">
        ...
        <form action="{{ route('instructor.update.playlist', $playlist->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="flex-btn">
                <a href="{{ route('instructor.playlist.details.view', $playlist->id) }}" class="option-btn">view playlist</a>
            </div>
