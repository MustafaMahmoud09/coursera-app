...
<body>
    ...
    <section class="comments">
        ...
        <h1 class="heading">solve assignments</h1>
                ...
                @foreach ($solutions as $solution)
                    <div class="box" style="order:-1">
                        <div class="content"><span>
                            ...
                            <p> - {{ $solution->student->email }} -
                            </p><a href="{{ route('instructor.playlist.content.details.view', $solution->content->id) }}">view content</a>
                        </div>
                        <iframe id="pdf-frame"
